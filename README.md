...
- **Python (v3.11.5)**: The primary programming language for development.  
...
- **Node Packet Manager (npm) (v10.8.2)**: Installs and manages JavaScript packages and tools used in the frontend development.
